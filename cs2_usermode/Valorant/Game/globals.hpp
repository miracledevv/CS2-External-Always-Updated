...
namespace offsets
{
    std::ptrdiff_t dwEntityList = 0x17BB860;
    std::ptrdiff_t dwViewMatrix = 0x1819FD0;
    std::ptrdiff_t dwLocalPlayerController = 0x180ACB0;
    std::ptrdiff_t dwLocalPlayerPawn = 0x16C2DD8;

    std::ptrdiff_t dwPawnHealth = 0x7F8;
    std::ptrdiff_t dwPlayerPawn = 0x7EC; //m_hPlayerPawn client.dll.rs
    std::ptrdiff_t dwSanitizedName = 0x750;
